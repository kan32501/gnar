...
class Player():
    ...
    def translate(self, delta_x, delta_y):
        ...
        for y in range(int(self.pos.y), int(new_pos.y), y_inc):
            # use floor + ceil to make sure that tracks are still being added when
            # the mouse pos is directly under the player
    ...
    def draw_tracks(self):
        ...
        for track in self.tracks:
            ...
            pygame.draw.rect(self.screen, shadow_color, left_track)
            pygame.draw.rect(self.screen, shadow_color, right_track)
