...
class SkiPatrol:
    def __init__(self):
        ...
        # extract assets
        self.start_img = pygame.image.load("src/assets/gnar.png").convert_alpha()
        self.pause_img = pygame.image.load("src/assets/pause.png").convert_alpha()
        self.game_over_img = pygame.image.load("src/assets/game_over.png").convert_alpha()
        self.gnar_pts_img = pygame.image.load("src/assets/gnar_pts.png").convert_alpha()
        self.score_0 = pygame.image.load("src/assets/0.png").convert_alpha()
        self.score_1 = pygame.image.load("src/assets/1.png").convert_alpha()
        self.score_2 = pygame.image.load("src/assets/2.png").convert_alpha()
        self.score_3 = pygame.image.load("src/assets/3.png").convert_alpha()
        self.score_4 = pygame.image.load("src/assets/4.png").convert_alpha()
        self.score_5 = pygame.image.load("src/assets/5.png").convert_alpha()
        self.score_6 = pygame.image.load("src/assets/6.png").convert_alpha()
        self.score_7 = pygame.image.load("src/assets/7.png").convert_alpha()
        self.score_8 = pygame.image.load("src/assets/8.png").convert_alpha()
        self.score_9 = pygame.image.load("src/assets/9.png").convert_alpha()
