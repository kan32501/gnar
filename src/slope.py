...
class Slope:
    ...
    def draw_avalanche(self):
        ...
        # draw the avalanche as an array of long snow columns that are of
        # dimension Slope.block_size * avalanche length
        for x in range(0, self.screen_w, Slope.block_size):
            ...
            # avalanche column
            avalanche_length = (Slope.block_size * (avalanche_height // Slope.block_size)
                                - Slope.block_size)
            ...
            avalanche_debris = pygame.Rect(x, avalanche_length,
                                           Slope.block_size,  Slope.block_size)
